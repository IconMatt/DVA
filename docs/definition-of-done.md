...
## Design quality
- Layout is polished across the seven project breakpoints (`xs:360`, `sm:560`, `md:840`, `lg:1120`, `xl:1440`, `2xl:1680`, `wide:1920`).
...
## Accessibility
- Keyboard flow works.
- Focus states are visible (`3px solid var(--color-focus)`).
- Landmarks and headings are correct.
- `prefers-reduced-motion` is respected at the component level too, not just the global scroll-animation host.
